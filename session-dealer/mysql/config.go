...
var (
	...
	dmlPatern         = regexp.MustCompile(`(?i)^\s*(insert|delete|update)`)
)
...
func init() {
	...
	flag.IntVar(&MaxMySQLPacketLen, "max_packet_length", 1024*1024, "max mysql packet length. Default is 1024 * 1024")
}
